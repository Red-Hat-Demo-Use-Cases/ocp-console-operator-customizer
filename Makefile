...
# dovid/ocp-console-customizer-bundle:$VERSION and dovid/ocp-console-customizer-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/dovid/ocp-console-customizer
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- podman buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile .
